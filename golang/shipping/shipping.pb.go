...
type CreateShippingResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DeliveryDays  int64                  `protobuf:"varint,1,opt,name=delivery_days,json=deliveryDays,proto3" json:"delivery_days,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_shipping_shipping_proto_rawDesc = "" +
	...
	"\fShippingItem\x12\x1a\n" +
	"\bquantity\x18\x01 \x01(\x05R\bquantity\"W\n" +
	...
	"\rdelivery_days\x18\x01 \x01(\x03R\fdeliveryDays2E\n" +
	"\bShipping\x129\n" +
	"\x06Create\x12\x16.CreateShippingRequest\x1a\x17.CreateShippingResponseB6Z4github/buenorafa/microservices-proto/golang/shippingb\x06proto3"
