...
func (x *CreateOrderRequest) GetCostumerId() int64 {
	if x != nil {
		return x.CostumerId
	}
	return 0
...
const file_order_order_proto_rawDesc = "" +
	...
	"\n" +
	"unit_price\x18\x03 \x01(\x01R\tunitPrice\"0\n" +
	"\x13CreateOrderResponse\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId2<\n" +
	"\x05Order\x123\n" +
	"\x06Create\x12\x13.CreateOrderRequest\x1a\x14.CreateOrderResponseB7Z5github.com/buenorafa/microservices-proto/golang/orderb\x06proto3"
